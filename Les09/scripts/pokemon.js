...
// volledig 'object' tonen
console.log(pokemonData);

// enkel results tonen
console.log(pokemonData.results);

// enkel de eerste pokemon uit results tonen
console.log(pokemonData.results[0]);

// enkel de NAAM van de eerste pokemon tonen
console.log(pokemonData.results[0].name);

// array maken met daarin enkel alle pokemon namen

// klassieke manier met loop (kan ook met foreach)
let pokemonNames = [];
...
// 'moderne' manier met map function
let pokemonNames2 = pokemonData.results.map(pokemon => pokemon.name);
